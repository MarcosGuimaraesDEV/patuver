...
<div id="popup">Este e-mail já está cadastrado!</div>
<div id="popup-success">Cadastro realizado com sucesso!</div>
<div id="popup-excluido">Usuário excluído com sucesso!</div>
            ...
            $('#uploadForm').submit(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#popup').text('Arquivo enviado com sucesso: ' + data).addClass('success-popup').fadeIn().delay(5000).fadeOut();
                        carregarListaArquivos(); // Atualiza a lista de arquivos após o envio de um novo arquivo
                        
                        // Limpar campos de arquivo e descrição após o upload
                        $('#fileToUpload').val('');
                        $('#fileDescription').val('');
                    },
                    error: function () {
                        $('#popup').text('Erro ao enviar o arquivo.').addClass('error-popup').fadeIn().delay(5000).fadeOut();
                    },
                    cache: false,
                    contentType: false,
                    processData: false
            ...
            $(document).on('click', '.deleteFile', function (e) {
                ...
                $.ajax({
                    ...
                    success: function () {
                        ...
                        $('#popup').text('Arquivo excluído com sucesso').addClass('success-popup').fadeIn().delay(5000).fadeOut();
                    },
                    error: function () {
                        $('#popup').text('Erro ao excluir o arquivo.').addClass('error-popup').fadeIn().delay(5000).fadeOut();
                    }
                });
            });
        });
...
<section id="contact" class="content-section" style="display: none;">
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <a class="download-button"
                href="Arquivos/Downloads/Instalação UniChef (Para primeira instalacao) 2016.71.exe" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <p>Instalador do Unicheff 6.0.2024.40 <br> <span style="color: red; font-weight: bold;">Instalador</span>
            </p>
    ...
    <div class="download-item">
        <img src="Arquivos/Imagens/iconCheff.ico" alt="Imagem do Download 3" width="100">
        <div>
            <h3>Unicheff 6.0.2024.61 - Todas Versões</h3>
            <p>Unicheff 6.0.2024.61 Todas Versões<br> <span
                    style="color: rgb(0, 81, 255); font-weight: bold;">Atualização</span> </p>
            <a class="download-button" href="Arquivos/Downloads/Unicheff 6.0.2024.61 - Todas Versões.zip"
                download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        <img src="Arquivos/Imagens/iconCheff.ico" alt="Imagem do Download 3" width="100">
        <div>
            <h3>Unicheff 6.0.2024.60 - Todas Versões</h3>
            <p>Unicheff 6.0.2024.60 Todas Versões<br> <span
                    style="color: rgb(0, 81, 255); font-weight: bold;">Atualização</span> </p>
            <a class="download-button" href="Arquivos/Downloads/Unicheff 6.0.2024.60 - Todas Versões.zip"
                download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        <img src="Arquivos/Imagens/iconCheff.ico" alt="Imagem do Download 3" width="100">
        <div>
            <h3>Unicheff 6.0.2024.53 - Todas Versões</h3>
            <p>Unicheff 6.0.2024.53 Todas Versões<br> <span
                    style="color: rgb(0, 81, 255); font-weight: bold;">Atualização</span> </p>
            <a class="download-button" href="Arquivos/Downloads/Unicheff 6.0.2024.53 - Todas Versões.zip"
                download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        <img src="Arquivos/Imagens/iconCheff.ico" alt="Imagem do Download 3" width="100">
        <div>
            <h3>Unicheff 6.0.2024.51 - Todas Versões</h3>
            <p>Unicheff 6.0.2024.51 Todas Versões<br> <span
                    style="color: rgb(0, 81, 255); font-weight: bold;">Atualização</span> </p>
            <a class="download-button" href="Arquivos/Downloads/Unicheff 6.0.2024.51 - Todas Versões.zip"
                download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <p>Versão Unicheff 6.0.2024.30 - Win10+<br> <span
                    style="color: rgb(0, 81, 255); font-weight: bold;">Atualização</span> </p>
            <a class="download-button" href="Arquivos/Downloads/Unicheff 6.0.2024.30 - Win10+.zip" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <p>Versão Unicheff 6.0.2024.24 - Win10+ <br> <span
                    style="color: rgb(0, 81, 255); font-weight: bold;">Atualização</span> </p>
            <a class="download-button" href="Arquivos/Downloads/Unicheff 6.0.2024.24 - Win10+.zip" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <p>Versão Unicheff 6.0.2024.23 - Win10+ <br> <span
                    style="color: rgb(0, 81, 255); font-weight: bold;">Atualização</span> </p>
            <a class="download-button" href="Arquivos/Downloads/Unicheff 6.0.2024.23 - Win10+.zip" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <p>Versão Unicheff 6.0.2024.22 - Win10+ <br> <span
                    style="color: rgb(0, 81, 255); font-weight: bold;">Atualização</span> </p>
            <a class="download-button" href="Arquivos/Downloads/Unicheff 6.0.2024.22 - Win10+.zip" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <p>Versão do Unicheff 6.0.2024.21 - Win10+ <br> <span
                    style="color: rgb(0, 81, 255); font-weight: bold;">Atualização</span> </p>
            <a class="download-button" href="Arquivos/Downloads/Unicheff 6.0.2024.21 - Win10+.rar" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <p>Versão do Unicheff 6.0.2024.20 <br> <span
                    style="color: rgb(0, 81, 255); font-weight: bold;">Atualização</span> </p>
            <a class="download-button" href="Arquivos/Downloads/Unicheff 6.0.2024.20 - Win10+.zip" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <p>Versão do Unicheff 6.0.2024.02 - Win10+.zip <br> <span
                    style="color: rgb(0, 81, 255); font-weight: bold;"> Atualização</span> </p>
            <a class="download-button" href="Arquivos/Downloads/Unicheff 6.0.2024.02 - Win10+.zip" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <p>Instalador do Unicheff 6.0.2023.200 <br> <span style="color: red; font-weight: bold;">Instalador</span>
            </p>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <a class="download-button" href="Arquivos/Downloads/Unicheff 6.0.2023.346 - Win10+.zip" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <a class="download-button" href="Arquivos/Downloads/Unicheff 6.0.2023.345 - Win10+.zip" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <p><span style="color: rgb(136, 62, 179); font-weight: bold;">Versão apenas para Win7+.zip.</span><br>
                <br> <span style="color: rgb(0, 81, 255); font-weight: bold;"> Atualização</span>.
            </p>
            </p>
            <a class="download-button" href="Arquivos/Downloads/Unicheff 6.0.2023.344 - Win7+.zip" download>Baixar</a>
        </div>
    </div>
...
<section id="programs" class="content-section">
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <a class="download-button" href="Arquivos/Downloads/Erros de impressora.rar" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        <img src="Arquivos/Imagens/Firmware.jpeg" alt="Imagem do Download 3" width="100">
        <div>
            <h3>DARUMA DR 700 | ATUALIZAÇÃO</h3>
            <p>Este artigo possui o objetivo de descrever o processo de atualização do firmware da impressora Daruma
                DR700.
            </p>
            <a class="download-button" href="Arquivos/Downloads/ToolAtualizaDR700e.zip" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <p>Mysql para processadores de arquitetura ARM. <span style="color: rgb(230, 39, 39); font-weight: bold;"> (
                    Hyorrana )</span></p>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <a class="download-button" href="Arquivos/Downloads/MiniTool Partition Wizard 12.8.rar" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        <img src="Arquivos/Imagens/ImageResizerXP.png" alt="Imagem do Download 3" width="100">
        <div>
            <h3>Image Resizer </h3>
            <p>Redimensionador de imagem.</p>
            <br> <!-- forma que eu encontrei para o botão ficar abaixo da imagem HEHEHEH-->
            <a class="download-button" href="Arquivos/Downloads/ImageResizer3.1.2.rar" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <a class="download-button" href="Arquivos/Downloads/AOMEI Partition Assistant 10.0.rar" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <a class="download-button" href="Arquivos/Downloads/Advanced_IP_Scanner_2.5.4594.1.exe" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <p>aplicativo de software abrangente projetado para atualizar drivers antigos ou desatualizados no
                Windows.</p>
            <a class="download-button" href="Arquivos/Downloads/Driver Booster Pro 11.2.0.46.rar" download>Baixar</a>
        </div>
    </div>
...
<section id="Ativadores" class="content-section" style="display: none;">
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <br> <!-- forma que eu encontrei para o botão ficar abaixo da imagem HEHEHEH-->
            <a class="download-button" href="Arquivos/Downloads/Office 2013 Permanent Activator.rar" download>Baixar</a>
        </div>
    </div>
...
<section id="links" class="content-section" style="display: none;">
    ...
    <ul class="link-list">
        ...
        <li><a href="https://drive.google.com/drive/folders/1ZD4xogO-_DHWIvXlruXXaesXDzqvgyV9" target="_blank">Google
                Driver📥</a></li>
...
<section id="services" class="content-section" style="display: none;">
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <p>correção do UniWhatsApp - v.3.0 <br><span style="color: rgb(230, 39, 39); font-weight: bold;">(
                    Instalador )</span></p>
            <a class="download-button" href="Arquivos/Downloads/UniRobo MenuCheff 1 - correção.zip" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <a class="download-button" href="Arquivos/Downloads/MenuCheff_Cardapio 3.6 32 bits.exe" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <p>Instalador Menucheff Cardápio 32 bits.</p>
            <a class="download-button" href="Arquivos/Downloads/MenuCheff_Cardapio 3.5 32 bits.exe" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <a class="download-button" href="Arquivos/Downloads/MenuCheff_Cardapio 3.4 64 bits.exe" download>Baixar</a>
        </div>
    </div>
   ...
   <h2 class="section-title"><span style="color: rgb(6, 8, 138); font-weight: bold;"> Multiempresa</span></h2>
    ...
    <div class="download-item">
        <img src="Arquivos/Imagens/UniCobranca.png" alt="Imagem do Cracker" width="100">
        <div>
            <h3>UniCobranca</h3>
            <p>Executável do UniCobranca.</p>
            <a class="download-button" href="Arquivos/Downloads/UniCobranca.exe" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <a class="download-button" href="Arquivos/Downloads/MenuCheff-Desktop-Setup-1.1.79.exe" download>Baixar</a>
        </div>
    </div>
    ...
    <div class="download-item">
        ...
        <div>
            ...
            <a class="download-button" href="Arquivos/Downloads/Gestor Integrador Install 1.12.rar" download>Baixar</a>
        </div>
    </div>
